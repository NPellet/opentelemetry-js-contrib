...
describe('AWSXRayPropagator', () => {
    ...
    describe('.inject()', () => {
        it('should inject sampled context', () => {
            ...
            xrayPropagator.inject(api_1.trace.setSpan(api_1.ROOT_CONTEXT, api_1.trace.wrapSpanContext(spanContext)), carrier, api_1.defaultTextMapSetter);
        ...
        it('inject default invalid spanContext - should inject nothing', () => {
            xrayPropagator.inject(api_1.trace.setSpan(api_1.ROOT_CONTEXT, api_1.trace.wrapSpanContext(api_1.INVALID_SPAN_CONTEXT)), carrier, api_1.defaultTextMapSetter);
            assert.deepStrictEqual(carrier, {});
        });
    });
    describe('.extract()', () => {
        ...
        it('should extract sampled context', () => {
            ...
            const extractedSpanContext = (_a = api_1.trace
                .getSpan(xrayPropagator.extract(api_1.ROOT_CONTEXT, carrier, api_1.defaultTextMapGetter))) === null || _a === void 0 ? void 0 : _a.spanContext();
